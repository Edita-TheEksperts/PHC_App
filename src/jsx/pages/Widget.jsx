          ...
          <div className="card">
            ...
            <div className="card-body px-0">
              <div
                style={{ height: "370px" }}
                id="DZ_W_TimeLine"
                className="widget-timeline dlab-scroll height370 px-4"
              >
          ...
          <div className="card">
            ...
            <div className="card-body px-0">
              <div
                style={{ height: "370px" }}
                id="DZ_W_TimeLine1"
                className="widget-timeline dlab-scroll style-1 height370 px-4"
              >
                <ul className="timeline">
                  <li>
                    <div className="timeline-badge primary"></div>
          ...
          <div className="card">
            ...
            <div className="card-body px-0">
              <div
                style={{ height: "370px" }}
                id="DZ_W_Todo1"
                className="widget-media dlab-scroll px-4"
              >
                <ul className="timeline">
                  <li>
          ...
          <div className="card border-0 pb-0">
            ...
            <div className="card-body px-0">
              <div
                style={{ height: "370px" }}
                id="DZ_W_Todo2"
                className="widget-media dlab-scroll height370 px-4"
              >
                <ul className="timeline">
                  <li>
                    <div className="timeline-panel">
