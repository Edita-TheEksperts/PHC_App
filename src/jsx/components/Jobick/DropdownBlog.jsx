		...
		<>
			<Dropdown className="text-center">
				...
				<Dropdown.Menu className="dropdown-menu-right" >
					<Dropdown.Item className="text-black"> <i className="far fa-check-circle me-1 text-success" /> Accept Order</Dropdown.Item>
					<Dropdown.Item className="text-black"><i className="far fa-times-circle me-1 text-danger" /> Reject Order </Dropdown.Item>		
				</Dropdown.Menu>			
			</Dropdown>
		</>
	)
