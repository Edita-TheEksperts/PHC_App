						...
						<tr role='row' className='odd'>
							...
							<td className="wspace-no">
								<div className="d-flex align-items-center">
									<div className='icon-img-bx sm me-2'>
									...
									<h6 className='mb-0 font-w400'>Bubbles Studios</h6>
								</div>
							</td>
							<td>FULLTIME</td>
							<td>UI Designer</td>
							...
							<td><span className="badge badge-dark light badge-rounded">Pending</span></td>
							<td><DropdownBlog /></td>
						</tr>
						<tr role='row' className='even'>
							...
							<td className="wspace-no">
								<div className="d-flex align-items-center">
									...
									<h6 className='mb-0 font-w400'>Kelon Team</h6>
								</div>
							</td>
							...
							<td><span className="badge badge-danger light badge-rounded">Candidate</span></td>
							<td><DropdownBlog /></td>
						</tr>
						<tr role='row' className='even'>
							<td className='application_sorting_1'>
							...
							<td className="wspace-no">
								<div className="d-flex align-items-center">
									...
									<h6 className='mb-0 font-w400'>Kripton Inc.</h6>
								</div>
							</td>
							...
							<td><span className="badge badge-secondary light badge-rounded">ON HOLD</span></td>
							<td><DropdownBlog /></td>
						</tr>
						<tr role='row' className='odd'>
							<td className='application_sorting_1'>
