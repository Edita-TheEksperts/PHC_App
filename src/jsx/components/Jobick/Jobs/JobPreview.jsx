		...
		<>
			<div className="card">
				...
				<div className="card-body">
					...
					<h4 className="mb-1 mt-2 text-center">UX Researcher</h4>
					...
					<div>
						<span className="mb-2 d-flex"><i className="fas fa-star orange me-3 mt-1"/>Tempor incididunt ut labore </span>	
						<span className="mb-2 d-flex"><i className="fas fa-star orange me-3 mt-1"/>Lorem ipsum dolor </span>	
						<span className="mb-2 d-flex"><i className="fas fa-star orange me-3 mt-1"/>Sit amet consectetur  </span>	
						<span className="mb-2 d-flex"><i className="fas fa-star orange me-3 mt-1"/>Labore adipsicans elit do uasde </span>	
					</div>
					<div className="location">
						<span className="fs-14 font-w500 d-flex align-items-center mb-3"><i className="fas fa-map-marker-alt"/>Manchester, England</span>
						<span className="fs-14 font-w500 d-flex align-items-center"><i className="fas fa-comment-dollar"/>$2,000 - $2,500</span>
					</div>
				</div>
