            ...
            <div className="card">
                ...
                <div className="card-body p-3">
                    <div className="table-responsive">
                        <div className="table-responsive dataTables_wrapper" id="license_table">
                            <table className="table mb-1 table-striped-thead table-wide table-sm" id="tableLicenseUsage">
                                <thead>
                                    <tr>
                                        <th>Status</th>
                                        <th>Operator</th>
                                        ...
                                        <tr key={index}>
                                            ...
                                            <td>
                                                <div className="select-text-wrap d-flex justify-content-between">
                                                    ...
                                                    <button className="btn-select-text btn p-0 border-0 ms-4"><i className="las la-copy fs-4"/>
                                                        <span>Copy</span>
                                                    </button>
                                                </div>
                                            </td>
                            ...
                            <div className='d-sm-flex text-center justify-content-between align-items-center mb-1'>
                                ...
                                <div className='dataTables_paginate paging_simple_numbers mb-0' id='example5_paginate'>
                                    <Link to='#' className='paginate_button previous disabled' onClick={() => activePag.current > 0 && onClick(activePag.current - 1)}>
                                    ...
                                    <Link to='#' className='paginate_button next' onClick={() => activePag.current + 1 < paggination.length && onClick(activePag.current + 1)}>
