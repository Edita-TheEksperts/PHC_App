...
const paymentBlog = [
    { image: IMAGES.CardJpg1, title:'Marcus Morris', cardname:'Card expires at 09/28', cardnumber:'Visa **** 1679', expire:'',},
    { image: IMAGES.CardJpg1, title:'Marcus Morris', cardname:'Card expires at 09/27', cardnumber:'Visa **** 1679', expire:'',},
    { image: IMAGES.CardJpg2, title:'Jason Davis', cardname:'Card expires at 02/26', cardnumber:'Mastercard **** 2704', expire:'',},
    { image: IMAGES.CardJpg2, title:'Jason Davis', cardname:'Card expires at 02/26', cardnumber:'Mastercard **** 2704', expire:'',},
];
                        ...
                        <div className="card h-auto">
                            <Tab.Container defaultActiveKey={'Week'}>
                                <div className="card-header border-0 py-3 d-block d-sm-flex pb-0">
                                    ...
                                    <Nav as="ul" className="nav nav-pills mt-3 mt-sm-0" id="myTabBillingHistory" role="tablist">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td className="text-end">
                                                                ...
                                                                <button type="button" className="btn btn-xxs btn-light ms-2">View</button>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>Oct 08, 2024</td>
