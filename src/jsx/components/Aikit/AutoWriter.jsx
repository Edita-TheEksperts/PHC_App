...
import { IMAGES, SVGICON } from '../../constant/theme.jsx';
								...
								<Accordion.Item>
									...
									<Accordion.Collapse id="collapseOne" className="collapse">
										<div className="accordion-body-text">
											...
											<div className="mb-3">
												<textarea className="form-control bg-transparent" id="exampleFormControlTextarea11" rows="3" defaultValue='Generate a title for an article that discusses the following topic: 
													[[description]] 
