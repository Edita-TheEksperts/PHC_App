...
const TableContent = [
	...
	{ id:8, position:'Java Developer', type:'Full-Time',pdate:'12-01-2021', ldate:'24-01-2021', cdate:'25-01-2021',status:'Active'},
	{ id:9, position:'IOS Developer', 	type:'Full-Time',pdate:'12-01-2021', ldate:'24-01-2021', cdate:'25-01-2021',status:'InActive'},
	{ id:10, position:'Junior Web Developer', type:'Full-Time',pdate:'12-01-2021', ldate:'24-01-2021', cdate:'25-01-2021',status:'Active'},
];
	...
	return(
		<>
			<div className="d-flex align-items-center mb-4 flex-wrap">
				<h3 className="me-auto">Job List</h3>
				<div>
			...
			<div className="row">
				...
				<div className="d-md-flex d-block align-items-center justify-content-between text-center  flex-wrap mt-md-0 mt-3">
					<div className='mb-md-0 mb-2'>
						<h5 className="mb-0">Showing 1 to 10 of 10 entries</h5>
					</div>
					<nav>
